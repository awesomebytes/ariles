...
namespace ariles2
{
    ...
    namespace aggregate
    {
        ...
        class ARILES2_VISIBILITY_PUBLIC ParametersWrapper
        {
        public:
        ...
        class ARILES2_VISIBILITY_PUBLIC Parameters<t_Visitor, t_Visitors...> : public ParametersWrapper<t_Visitor>,
        ...
        template <class t_Visitor>
        class ARILES2_VISIBILITY_PUBLIC BaseVisitorWrapper
        {
        public:
            t_Visitor visitor_;
        ...
        template <class... t_Visitors>
        class ARILES2_VISIBILITY_PUBLIC BaseVisitor;
        ...
        template <class t_Visitor, class... t_Visitors>
        class ARILES2_VISIBILITY_PUBLIC BaseVisitor<t_Visitor, t_Visitors...> : public BaseVisitorWrapper<t_Visitor>,
        ...
        class ARILES2_VISIBILITY_PUBLIC Visitor : public BaseVisitor<t_Visitors...>,
